...
Route::post('/komentar/{id_informasi}', 'PengunjungController@komentar');
Route::get('/single_berita/{id}', 'InformasiController@single_berita');
Route::get('/allInformasi/{id}', 'InformasiController@allInformasi');
...
Route::get('/informasi/cari', 'InformasiController@search');
Route::group(['middleware' => ['auth', 'CheckStatus:admin,warga']], function () {
    ...
    Route::post('/informasi/create/{id_admin}', 'InformasiController@create');
    ...
    Route::get('/perangkatDesa', 'KadesController@index');
    Route::get('/perangkatDesa/{id}/edit', 'KadesController@edit');
    Route::get('/perangkatDesa/{id}/delete', 'KadesController@delete');
    Route::post('/kades/create', 'KadesController@addKades');
    Route::post('/kades/{id}/update', 'KadesController@update');
    Route::get('/sejarah', 'SejarahController@index');
    Route::post('/sejarah/create', 'SejarahController@create');
    Route::get('/sejarah/{id}', 'SejarahController@edit');
    Route::post('/sejarah/{id}/update', 'SejarahController@update');
    Route::get('/sejarah/{id}/delete', 'SejarahController@delete');
    Route::get('/category', 'CategoryController@index');
    Route::post('/category/create', 'CategoryController@create');
    Route::get('/category/{id}/edit', 'CategoryController@edit');
    Route::post('/category/{kategori}/update', 'CategoryController@update');
    Route::get('/category/{kategori}/delete', 'CategoryController@delete');
