                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated">
                                <a class="dropdown-item" href="/dashboard"><i class="ti-user m-r-5 m-l-5"></i>{{ auth()->user()->name }}</a>
                                @if(auth()->user()->status == 'warga')
                                <a class="dropdown-item" href="/isiBiodata"><i class="mdi mdi-face m-r-5 m-l-5"></i>Lengkapi Data</a>
                                @endif
                                ...
                                <div class="p-l-30 p-10"><a href="/profile/{{ auth()->user()->id }}/admin" class="btn btn-sm btn-success btn-rounded">View Profile</a></div>
                                @endif
                            </div>
                        </li>
                        <!-- ============================================================== -->
